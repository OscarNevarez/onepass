...
import onepass.repository.EntryRepository;
...
public class EntryResourceIntTest {
    ...
    public void createEntry() throws Exception {
        ...
        assertThat(testEntry.getUsername()).isEqualTo(DEFAULT_USERNAME);
        assertThat(testEntry.getPassword()).isEqualTo(DEFAULT_PASSWORD);
    }
    ...
    public void updateEntry() throws Exception {
        ...
        Entry testEntry = entryList.get(entryList.size() - 1);
        assertThat(testEntry.getUsername()).isEqualTo(UPDATED_USERNAME);
        assertThat(testEntry.getPassword()).isEqualTo(UPDATED_PASSWORD);
    }
